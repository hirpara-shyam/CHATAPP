...
const ChatContainer = ({ onToggleSidebar }) => {
    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      {/* {header} */}
        <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
          ...
          <img src={assets.help_icon} alt='' className='max-w-5 cursor-pointer' onClick={onToggleSidebar}/>
        </div>
        ...
        <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
          {messages.map((msg, index) => {
            ...
            return (
              ...
              >
                {!isMe && (
                  <div className="flex flex-col items-center mr-2 min-w-[50px]">
                    <img src={profilePic} className="w-6.5 h-6.5 rounded-full object-cover mb-1" />
                ...
                {isMe && (
                  <div className="flex flex-col items-center ml-2 min-w-[50px]">
                    <img src={profilePic} className="w-7 h-7 rounded-full mb-1" />
                    <span className="text-[10px] text-gray-400">{formatMessageTime(msg.createdAt)}</span>
                  </div>
                )}
              </div>
